...
A logged-in patient must not be able to get a case created without a real, server-validated
payment. Anything touching consultation pricing must keep these invariants:
